...
Year 7 Digital Technologies is a one semester course that forms part of the Year 7 Program at Canberra Grammar School. The course is based upon, and complies with, the Digital Technologies framework from the Australian Curriculum, Assessment and Reporting Authority.
...
A $50 charge will appear on your school account to cover the cost of the resources for this course.
...
For this course, you are required to have your own laptop computer running full Windows or Mac OS.
...
Given the technical nature of this course you may sometimes have difficulty understanding concepts or completing the set work. Below are some ways you can seek assistance should you need help.

* *Email the Teacher.* You should email your teacher if you are having difficulty and need assistance or if you want to talk to them about something privately.
