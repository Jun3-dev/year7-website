...
= Year 7 IT &mdash; Semester Two 2019

== Unit Outline and Assessment Schedule

=== Report Criteria / Areas of Learning

* Developing more complex systems and programs using block-based programming languages.
* Identifies and evaluates possible digital solutions to real-world problems
* Presents ideas comprehensively and professionally, demonstrating in-depth research
* Demonstrates an understanding of mobile application development and design
* Effectively communicates and collaborates within a team
